AFRAME.registerComponent('door-hover', {
  ...
  init() {
    ...
    this.hoveredOn = () => {
      ...
      this.el.setAttribute('animation', `property: scale; to: 2 2 2; easing: easeInOutSine; dur: 1000; delay:500`)
    ...
    this.hoveredOff = () => {
      this.el.setAttribute('animation', `property: scale; to: 1 1 1; easing: easeInOutSine; dur: 1000; delay:500`)
